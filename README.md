...
A self-contained, open-source financial sandbox for analyzing companies listed on the WIG20 Warsaw Stock Exchange (GPW) WIG20 index. **No data fetching required**—this repository comes pre-loaded with historical EOD (End of Day) CSV datasets from 5-1-2026 till 7-2-2026 so you can start simulating instantly.
